...
print("t=",t)
          ...
          --if t ~= 850000 then
        	if t <= 850000 then r[format_addr(tbl[i])] = t/10000 end
            --r[tbl[i]]=t
        	tbl[i] = nil
    	    end
    	end
...
-- start measuring every 5s
tmr.alarm(6,5000,1,function() readT(4,function(r) for k,v in pairs(r) do print(k,string.format("%.3f",v)) end end) end)
