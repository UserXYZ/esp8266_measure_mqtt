...
if _cfg["tz"] == nil then _cfg["tz"] = 2 end                    -- local timezone in hours
if _cfg["ntpserver"] == nil then _cfg["ntpserver"] = "pool.ntp.org" end   -- address of NTP server
